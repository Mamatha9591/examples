...
app.post("/weather", function(req, res) {
  ...
  var cityCode = 0;
  var url =
    " http://dataservice.accuweather.com/locations/v1/cities/mx/search?apikey=jRA2Qxo7B4marmaKlBKjn1yUqKrUeHl9&q=" +
    city;
  ...
  request(url, { json: true }, (err, resp, body) => {
    ...
    if (err) {
      ...
      console.log(err);
      resClima.fulfillmentText =
        "It was not possible to consult your city at this time";
    } else {
      if (body.length == 0) {
        console.log("City not found");
        resClima.fulfillmentText =
          " Your city has not been found, make sure you have written it correctly";
        res.json(resClima);
      } else {
        ...
        var url =
          ...
          cityCode +
          "?apikey=jRA2Qxo7B4marmaKlBKjn1yUqKrUeHl9&language=es";
        ...
        request(url, { json: true }, (err2, resp2, body2) => {
          ...
          if (err2) {
            ...
            resClima.fulfillmentText =
              "It was not possible to consult the climate of your city at this time";
          }
          ...
          // more details https://developer.accuweather.com/accuweather-current-conditions-api/apis/get/currentconditions/v1/%7BlocationKey%7D
            ...
            resClima.fulfillmentText =
              ...
              city +
              "is" +
              body2[0].Temperature.Metric.Value +
              "and" +
              body2[0].WeatherText;
          }
